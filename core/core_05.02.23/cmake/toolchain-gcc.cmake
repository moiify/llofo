...
if(CONFIG_CPU_ARM_CA5)
    ...
    set(libc_file_name ${CMAKE_CURRENT_SOURCE_DIR}/core/core_05.02.23/components/newlib/armca5/libc.a)
    set(libm_file_name ${CMAKE_CURRENT_SOURCE_DIR}/core/core_05.02.23/components/newlib/armca5/libm.a)
endif()
...
if(CONFIG_CPU_ARM_CM4F)
    set(abi_options -mcpu=cortex-m4 -mtune=cortex-m4 -mthumb -mfpu=fpv4-sp-d16
        -mfloat-abi=hard -mno-unaligned-access)
    set(partial_link_options)
    set(libc_file_name ${CMAKE_CURRENT_SOURCE_DIR}/core/core_05.02.23/components/newlib/armcm4f/libc.a)
    set(libm_file_name ${CMAKE_CURRENT_SOURCE_DIR}/core/core_05.02.23/components/newlib/armcm4f/libm.a)
endif()
...
if(CONFIG_CPU_MIPS_XCPU)
    ...
    set(libc_file_name ${CMAKE_CURRENT_SOURCE_DIR}/core/core_05.02.23/components/newlib/xcpu/libc.a)
    set(libm_file_name ${CMAKE_CURRENT_SOURCE_DIR}/core/core_05.02.23/components/newlib/xcpu/libm.a)
endif()

if(CONFIG_CPU_MIPS_XCPU2)
    set(abi_options -march=xcpu2 -mtune=xcpu2 -EL -mips16 -msoft-float -mno-gpopt -G0)
    set(partial_link_options -EL)
    set(libc_file_name ${CMAKE_CURRENT_SOURCE_DIR}/core/core_05.02.23/components/newlib/xcpu2/libc.a)
    set(libm_file_name ${CMAKE_CURRENT_SOURCE_DIR}/core/core_05.02.23/components/newlib/xcpu2/libm.a)
endif()
