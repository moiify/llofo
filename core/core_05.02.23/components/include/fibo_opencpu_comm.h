...
typedef enum
{
    ...
    GAPP_SIG_TTS_END = 73,
    GAPP_SIG_AUDREC_END = 74,
    GAPP_SIG_LWM2M_EVENT_BASE = 80,
    GAPP_SIG_LWM2M_EVENT_BOOTSTRAP_START = 81,
    GAPP_SIG_LWM2M_EVENT_BOOTSTRAP_SUCCESS = 82,
    GAPP_SIG_LWM2M_EVENT_BOOTSTRAP_FAILED = 83,
    GAPP_SIG_LWM2M_EVENT_CONNECT_SUCCESS = 84,
    GAPP_SIG_LWM2M_EVENT_CONNECT_FAILED = 85,
    GAPP_SIG_LWM2M_EVENT_REG_SUCCESS = 86,
    GAPP_SIG_LWM2M_EVENT_REG_FAILED = 87,
    GAPP_SIG_LWM2M_EVENT_REG_TIMEOUT = 88,
    GAPP_SIG_LWM2M_EVENT_LIFETIME_TIMEOUT = 89,
    GAPP_SIG_LWM2M_EVENT_STATUS_HALT = 90,
    GAPP_SIG_LWM2M_EVENT_UPDATE_SUCCESS = 91,
    GAPP_SIG_LWM2M_EVENT_UPDATE_FAILED = 92,
    GAPP_SIG_LWM2M_EVENT_UPDATE_TIMEOUT = 93,
    GAPP_SIG_LWM2M_EVENT_UPDATE_NEED = 94,
    GAPP_SIG_LWM2M_EVENT_UNREG_DONE = 95,
    GAPP_SIG_LWM2M_EVENT_RESPONSE_FAILED = 100,
    GAPP_SIG_LWM2M_EVENT_RESPONSE_SUCCESS = 101,
    GAPP_SIG_LWM2M_EVENT_NOTIFY_FAILED = 105,
    GAPP_SIG_LWM2M_EVENT_NOTIFY_SUCCESS = 106,
    GAPP_SIG_LWM2M_EVENT_OBSERVER_REQUEST = 107,
    GAPP_SIG_LWM2M_EVENT_DISCOVER_REQUEST = 108,
    GAPP_SIG_LWM2M_EVENT_READ_REQUEST = 109,
    GAPP_SIG_LWM2M_EVENT_WRITE_REQUEST = 110,
    GAPP_SIG_LWM2M_EVENT_EXECUTE_REQUEST = 111,
    GAPP_SIG_LWM2M_EVENT_SET_PARAM_REQUEST = 112,
