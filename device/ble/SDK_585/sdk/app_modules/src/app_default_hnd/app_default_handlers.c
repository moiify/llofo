...
void default_advertise_operation(void)
{
    ...
    {
        app_easy_gap_undirected_advertise_with_timeout_start(user_default_hnd_conf.advertise_period, NULL);//5.we need use to stop adv after advertise_period 5s
    }
}
...
{
    // Restart Advertising
    CALLBACK_ARGS_0(user_default_app_operations.default_operation_adv) //vag mine
}
