...
extern bool fibo_sweep_code(camastae_t *cam, uint16_t *pFrame, uint8_t *pDatabuf, uint8_t *pResult, uint32_t *pReslen);
...
extern INT8 fibo_play_tone_ex(AUDIO_TONE_EX_T freq);
//mbedtls
...
//lwm2m
extern INT32 fibo_lwm2m_create(UINT32 total_size, UINT8 *config, UINT32 index, UINT32 cur_size);
extern INT32  fibo_lwm2m_delete(UINT32 ref);
extern INT32 fibo_lwm2m_open(UINT32 ref, UINT32 lifetime);
extern INT32  fibo_lwm2m_close(UINT32 ref);
extern INT32 fibo_lwm2m_addobj(UINT32 ref, UINT32 objid, UINT32 instanceconut, UINT8 *instancebitmap, UINT32 attrcount, UINT32 actoncount);
extern INT32  fibo_lwm2m_delobj(UINT32 ref, UINT32 objid);
extern INT32  fibo_lwm2m_notify(UINT32 ref, UINT32 msgid, INT32 objid, INT32 instid, INT32 resid, INT32 valuetye, INT32 length, UINT8 *value, INT32 index, INT32 ackid);
extern INT32  fibo_lwm2m_read_response(UINT32 ref, UINT32 msgid, UINT32 retcode, INT32 objid, INT32 instid, INT32 resid, INT32 valuetye, INT32 length, UINT8 *value, INT32 index);
extern INT32  fibo_lwm2m_write_response(UINT32 ref, UINT32 msgid, UINT32 retcode);
extern INT32  fibo_lwm2m_execute_response(UINT32 ref, UINT32 msgid, UINT32 retcode);
extern INT32  fibo_lwm2m_observe_response(UINT32 ref, UINT32 msgid, UINT32 retcode);
extern INT32  fibo_lwm2m_discover_response(UINT32 ref, UINT32 msgid, UINT32 retcode, UINT32 length, UINT8 *value);
extern INT32  fibo_lwm2m_parameter_response(UINT32 ref, UINT32 msgid, UINT32 retcode);
extern INT32  fibo_lwm2m_update(UINT32 ref, UINT32 lifetime, INT32 withobjectflag);
