...
enum nmeaPACKTYPE
{
    ...
    GPGGA   = 0x0001,   /**< GGA - Essential fix data which provide 3D location and accuracy data. elevation */
    GPGSA   = 0x0002,   /**< GSA - GPS receiver operating mode, SVs used for navigation, and DOP values. */
    GPGSV   = 0x0004,   /**< GSV - Number of SVs in view, PRN numbers, azimuth & SNR values. */
